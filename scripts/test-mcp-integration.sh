...
INIT_RESPONSE=$(echo '{"jsonrpc": "2.0", "id": 1, "method": "initialize", "params": {"protocolVersion": "2024-11-05", "capabilities": {}, "clientInfo": {"name": "test-client", "version": "1.0.0"}}}' | target/release/cadi-mcp-server 2>/dev/null)
...
TOOLS_RESPONSE=$(echo '{"jsonrpc": "2.0", "id": 2, "method": "tools/list", "params": {}}' | target/release/cadi-mcp-server 2>/dev/null)
...
RESOURCES_RESPONSE=$(echo '{"jsonrpc": "2.0", "id": 3, "method": "resources/list", "params": {}}' | target/release/cadi-mcp-server 2>/dev/null)
...
SEARCH_RESPONSE=$(echo '{"jsonrpc": "2.0", "id": 4, "method": "tools/call", "params": {"name": "cadi_search", "arguments": {"query": "test"}}}' | target/release/cadi-mcp-server 2>/dev/null)
